      ...
      @if (session('status'))
        ...
        <div class="apply-popup">
                      ...
                      <div class="modal-dialog" role="document" >
                        <div class="modal-content" style="width:150%">
                          ...
                          <div class="jy-alert info-alert">
                            <p> Vous ètes en ce moment en train de candidater pour le poste <strong>{{$job[0]->titre}}</strong> dans l'entreprise <em> {{$job[0]->user->name}} </em>   </p>
                          </div>
                   ...
                   <br><br><h6> Informations sur les motivations du Candidat </h6><br><br>
                      ...
                      <div id="job-summery" class="row">
                          <div class="col-md-6">
                              <label class="col-md-12 col-form-label"> Êtes-vous mobile ?</label>
                              <div class="col-md-12">
                                <div class="form-group">
                                  <div class="form-group">
