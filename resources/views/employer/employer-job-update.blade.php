			  ...
			  <div class="job-title-and-info">
                ...
                <form  method="POST" action="{{route('employer.job-update',  $post->id)}}" class="dashboard-form job-post-form">
                  ...
                  <div class="dashboard-section basic-info-input">
                    <h4><i data-feather="user-check"></i>Éditer cette Offre</h4>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group datepicker">
                                <input name ="date_exp" type="text" value="{{$post->date_exp}}" reqquired class="form-control">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <label class="col-md-6 col-form-label">Diplôme</label>
                            <div class="form-group">
                              <input type="text" name="diplome" value="{{$post->diplome}}" class="form-control" required placeholder="Diplôme">
                            </div>
                          </div>
                          <div class="col-md-6">
                          ...
                          <label class="col-md-6 col-form-label">Certification</label>
                            <div class="form-group">
                              <input type="text" name="certif" value="{{$post->certif}}" class="form-control" required placeholder="Certification">
                            </div>
                          </div>
                          <div class="col-md-6">
