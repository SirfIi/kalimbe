                     					...
                     					<div class="col-md-12">
                         					<div class="row">
												...
												{{-- <div class="col-md-9">
													...
													<div class="form-group">
														<select multiple class="form-control" name="localisation[]" style="height: 120px">
															<option  value="afghanistan" class="afghanistan">Afghanistan</option>
															<option  value="afrique-du-sud" class="afrique-du-sud">Afrique du Sud</option>
															<option  value="albanie" class="albanie">Albanie</option>
															<option  value="algerie" class="algerie">Algérie</option>
												...
												<div class="col-md-3">
													<section class='rating-widget'>
														...
														<div class='rating-stars text-center'>
															...
															<input type="text" name="val_lieu" id="val_lieu" style="display: none">
														</div>
													</section>
												</div> --}}
												{{-- <div class="col-md-9">
													...
													<div class="form-group">
														<select multiple name ="type_contrat[]" class="form-control" style="height: 100px">
															<option>CDI Temps plein</option>
															<option>CDI Temps partiel</option>
															<option>CDD Temps plein</option>
															<option>CDD Temps partiel</option>
												...
												<div class="col-md-3">
													<section class='rating-widget'>
														...
														<div class='rating-stars text-center'>
															...
															<input type="text" name="val_contract" id="val_contract" style="display: none">
														</div>
													</section>
												</div> --}}
												{{-- <div class="col-md-9">
												...
												<div class="col-md-3">
													<section class='rating-widget'>
														...
														<div class='rating-stars text-center'>
															...
															<input type="text" name="val_salaire" id="val_salaire" style="display: none">
														</div>
													</section>
												</div> --}}
												{{-- <div class="col-md-9">
