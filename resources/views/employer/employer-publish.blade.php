...
<div class="alice-bg section-padding-bottom">
              ...
              <div class="dashboard-content-wrapper">
                ...
                <form  method="POST" action="{{ route('employeur.post') }}" class="dashboard-form job-post-form">
                  ...
                  <div class="dashboard-section basic-info-input">
                    <h4><i data-feather="user-check"></i>Publier une offre</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                          <div class="col-md-6">
                          <label class="col-md-6 col-form-label">Secteur d'activité</label>
                          ...
                          <div class="col-md-6">
                          <label class="col-md-6 col-form-label">Lieu du Travail</label>
                            <div class="form-group">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group datepicker">
                                <input name ="date_exp" type="date" reqquired class="form-control">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-md-6">
                          <label class="col-md-6 col-form-label">Diplôme</label>
                            <div class="form-group">
                              <input type="text" name="diplome" class="form-control" required placeholder="Diplôme">
                            </div>
                          </div>
                          <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                          <label class="col-md-6 col-form-label">Certification</label>
                            <div class="form-group">
                              <input type="text" name="certif"class="form-control" required placeholder="Certification">
                            </div>
                          </div>
                          <div class="col-md-6">
                   ...
                   <br><h6>Description du poste</h6><br>
                    <div class="row">
                    ...
                    <br><h6>Reférences de l'emploi</h6><br>
                    ...
                    <div class="col-12" >
                              ...
                              <div class="form-group">
                                  <div class="form-group">
                                      <select name="skill_1" class="form-control">
                                          <option>Compétences techniques  </option>
                                          <option>Compétences en management  </option>
                      ...
                      <div class="row">
                        <div class="col-md-5">
                          ...
                          <div class="form-group">
                            <div class="form-group">
                              <input type="text" name="comp_1"class="form-control" placeholder="" id="compr1" >
                            </div>
                          </div>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="col-12" >
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <div class="form-group">
                                      <select name="skill_2"class="form-control" id="comp" >
                                          <option>Compétences techniques  </option>
                      ...
                      <div class="row">
                          ...
                          <label class="col-md-3 col-form-label">Compétence requise </label>
                              <div class="form-group">
                                  <div class="form-group">
                                    <input type="text" name="comp_2" class="form-control" placeholder=""  id="compr2">
                                  </div>
                                </div>
                          </div>
                          <div class="col-md-5">
                          ...
                          <div onclick="closeTap(1, compr2)"class="col-md-2">
                          <i class="fas fa-trash-alt"></i>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-12" >
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <div class="form-group">
                                      <select name="skill_3"class="form-control" id="comp">
                      ...
                      <div class="row">
                          ...
                          <label class="col-md-3 col-form-label">Compétence requise </label>
                              <div class="form-group">
                                  <div class="form-group">
                                    <input name="comp_3" type="text" class="form-control" placeholder="" id="compr3">
                                  </div>
                                </div>
                          </div>
                          <div class="col-md-5">
                          ...
                          <div onclick="closeTap(2, compr3)"class="col-md-2">
                            <i class="fas fa-trash-alt"></i>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <div class="form-group">
                                      <select name="skill_4" class="form-control" id="comp" >
                                          <option>Compétences techniques  </option>
                      ...
                      <div class="row">
                          ...
                          <label class="col-md-3 col-form-label">Compétence requise </label>
                              <div class="form-group">
                                  <div class="form-group">
                                    <input type="text" name="comp_4" class="form-control" placeholder=""id="compr4">
                                  </div>
                                </div>
                          </div>
                          <div class="col-md-5">
                          ...
                          <div onclick="closeTap(3, compr4)" class="col-md-2">
                            <i class="fas fa-trash-alt"></i>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              <div class="form-group">
                                  <div class="form-group">
                                      <select name="skill_5" class="form-control" >
                                          <option>Compétences techniques  </option>
                      ...
                      <div class="row">
                          ...
                          <label class="col-md-3 col-form-label">Compétence requise </label>
                              <div class="form-group">
                                  <div class="form-group">
                                    <input name="comp_5" type="text" class="form-control" placeholder="" id="compr5" >
                                  </div>
                                </div>
                          </div>
                          <div class="col-md-5">
                          ...
                          <div class="col-md-2">
                            <i onclick="closeTap(4, compr5)" class="fas fa-trash-alt"></i>
                          </div>
                      </div>
                    </div>
                    </div>
    ...
    <script>
      ...
      tabcontent = document.getElementsByClassName("job-summery");
      ...
      function closeTap(i, id){
        console.log(i);
        tabcontent[i].style.display = "none";
      
     //   var compr = document.getElementById('compr1');
