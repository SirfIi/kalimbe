          ...
          <div class="col-xl-4 col-md-6">
            <div class="access-form">
              <div class="form-header">
                <h5><i data-feather="edit"></i>Créer un nouveau Compte</h5>
              </div>
              <form method="POST" action="{{ route('register') }}">
                ...
                {!! NoCaptcha::display() !!}
                  ...
                  <div class="form-group">
					...
					<p>J'accepte les <a href="{{url('conditions/candidats')}}">  Termes & Conditions</a></p>
					</div>
              ...
              <div class="shortcut-login">
                <p>Vous avez déja un Compte? <a href="{{ url('login_') }}">Login</a></p>
              </div>
            </div>
          </div>
        </div>
